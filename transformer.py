...
class Transformer:
    def __init__(self, sequence_length, source_vocab_size, target_vocab_size,
        ...
        self.source = tf.placeholder(tf.int32, shape=[None, sequence_length], name='source')
        self.target = tf.placeholder(tf.int32, shape=[None, sequence_length], name='target')
        ...
        with tf.variable_scope("encoder"):
            ...
            with tf.variable_scope("positional-encoding"):
                ...
                self.enc = tf.add(self.source_embedded_chars, self.pos_enc, name="encoded_input")
        ...
        with tf.variable_scope("decoder"):
            ...
            with tf.variable_scope("positional-encoding"):
                self.pos_enc = self.position_encoding(sequence_length, hidden_size)
                self.dec = tf.add(self.target_embedded_chars, self.pos_enc, name="encoded_input")
